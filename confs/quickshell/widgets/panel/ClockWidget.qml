...
Button {
    ...
    background: Rectangle {
        ...
        color: clockWidge.pressed ? Theme.WidgetStyle.pressedColor :
               (clockWidge.hovered ? Theme.WidgetStyle.hoverColor : Theme.WidgetStyle.normalColor)
    ...
    contentItem: Item {
        ...
        Row {
            ...
            Text {
                ...
                font.pixelSize: 13
                font.weight:Font.Bold // clockWidge.hovered ? Font.Bold : Font.Light
            ...
            Item {
                ...
                Text {
                    ...
                    font.family: Theme.WidgetStyle.fontFamily
                    font.pixelSize: 11
                    font.weight: clockWidge.hovered ? Font.Bold : Font.Light
                    color: Theme.ColorScheme.textHighEmphasis
